...
def lookup(chord):
    ...
    if stress == "*" and start_consonant in starting_consonants["tense"]:
        start_offset, start_final = starting_consonants["tense"][start_consonant]
    elif start_consonant in starting_consonants["regular"]:
        start_offset, start_final = starting_consonants["regular"][start_consonant]
    elif start_consonant in starting_consonants["special"]:
        add_y = True
        start_offset, start_final = starting_consonants["special"][start_consonant]
    else:
        raise KeyError
